...
export class UsersController {
  ...
  @Patch(':id')
  updatePartial(@Param('id') id: string, @Body() partialUpdateDto: Partial<UpdateUserDto>) {
...
export class UsersController {
  ...
  @ApiOperation({ summary: 'Get all users', description: 'Retrieve a list of all users with pagination' })
...
*You now know how to build different types of APIs! 🚀*
